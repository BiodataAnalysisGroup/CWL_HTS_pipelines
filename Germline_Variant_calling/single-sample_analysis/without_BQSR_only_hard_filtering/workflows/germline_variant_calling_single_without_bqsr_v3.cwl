...
steps:
    ...
    gather_bwa_sam_files:
        ...
        out: [total_sam_files,
              ...
              names_snp_vcf,
              names_indel_vcf,
              names_filtered_snp_vcf,
              names_filtered_indel_vcf,
              names_bcftools_concat_vcf,
              names_bcftools_hard_filtered_vcf,
              names_cnn_vcf,
              names_cnn_filtered_vcf,
              names_bcftools_cnn_filtered_vcf]
    ...
    gatk_haplotypecaller_subworkflow:
        run: ../workflows/gatk-haplotypecaller-without-bqsr-subworkflow.cwl
        scatterMethod: dotproduct
        scatter: 
        - hf_INPUT
        - hf_OUTPUT
        in: 
            ...
            hf_OUTPUT: gather_bwa_sam_files/names_basenames
    ...
    gatk_SelectVariants_snps:
        ...
        in:
            ...
            OUTPUT: gather_bwa_sam_files/names_snp_vcf
            variant_type: 
              valueFrom: $( "SNP" )
        out: [output]
    # INDELs
    gatk_SelectVariants_indels:
        ...
        in:
            reference: reference_genome
            variant: gatk_haplotypecaller_subworkflow/o_gatk_MergeVCFs
            OUTPUT: gather_bwa_sam_files/names_indel_vcf
            variant_type: 
              valueFrom: $( "INDEL" )
        out: [output]
    ...
    gatk_VariantFiltration_snps:
        ...
        in:
            ...
            OUTPUT: gather_bwa_sam_files/names_filtered_snp_vcf
        out: [output]
    # INDELs
    gatk_VariantFiltration_indels:
        ...
        in:
            ...
            OUTPUT: gather_bwa_sam_files/names_filtered_indel_vcf
        out: [output]
    ### bgzip - tabix ###
    # SNPs
    bgzip_snps:
    ...
    bcftools_concat:
        ...
        in: 
            ...
            output_name: gather_bwa_sam_files/names_bcftools_concat_vcf
        out: [output]
    ...
    bcftools_view_hard_filter:
        ...
        in: 
            ...
            output_name: gather_bwa_sam_files/names_bcftools_hard_filtered_vcf
        out: [output]
    ### bcftools norm ###
