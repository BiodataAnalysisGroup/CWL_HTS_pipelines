...
outputs:
    ...
    outFastq_fwd_paired:
        type: File?
        outputBinding:
            glob: $( inputs.input_fastq_fwd.basename.split(inputs.file_split)[0].concat(inputs.file_split_fwd_single, "_trimmed.fastq.gz") ) # $(inputs.output_fastq_fwd_paired)
            outputEval: 
             ${
                if(self.length === 0){
                    return {};
    ...
    outFastq_fwd_unpaired:
        type: File?
        outputBinding:
            glob: $( inputs.input_fastq_fwd.basename.split(inputs.file_split)[0].concat(inputs.file_split_fwd_single, "_trimmed_unpaired.fastq.gz") ) # $(inputs.output_fastq_fwd_unpaired)
            outputEval: 
             ${
                if(self.length === 0){
                    return {};
    ...
    outFastq_rev_paired:
        type: File?
        outputBinding:
            glob: $( inputs.input_fastq_fwd.basename.split(inputs.file_split)[0].concat(inputs.file_split_rev, "_trimmed.fastq.gz") ) # $(inputs.output_fastq_rev_paired)
            outputEval: 
             ${
                if(self.length === 0){
                    return {};
    ...
    outFastq_rev_unpaired:
        type: File?
        outputBinding:
            glob: $( inputs.input_fastq_fwd.basename.split(inputs.file_split)[0].concat(inputs.file_split_rev, "_trimmed_unpaired.fastq.gz") ) # $(inputs.output_fastq_rev_unpaired)
            outputEval: 
             ${
                if(self.length === 0){
                    return {};
