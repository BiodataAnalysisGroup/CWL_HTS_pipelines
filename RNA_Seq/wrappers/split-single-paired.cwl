...
- id: cp_command_paired
  type: string
- id: fastx_command_single
  type: string
- id: fastx_command_paired
  type: string
...
expression: |
  ${
    ...
    // fastx-trimmer
    var fx_command_single = "/usr/local/bin/fastx_trimmer";
    var fx_command_paired = "/usr/local/bin/fastx_trimmer";
    ...
    return {
      ...
      "fastx_command_single": fx_command_single,
      "fastx_command_paired": fx_command_paired
    };
  }